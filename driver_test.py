...
if __name__ == '__main__':
    ...
    main()
    print(f'Encoding time:{time.time_ns() - time_start} ns')
    time_start = time.time_ns()
    sys.argv[1] = '-d'
    sys.argv[2] = f_encoded
    main()
    print(f'Decoding time:{time.time_ns() - time_start} ns')
    time_start = time.time_ns()
    ...
    with open(f_in, 'r', encoding='utf-8') as f1:
        with open(f_decoded, 'r', encoding='utf-8') as f2:
            ...
            if src != decoded:
                ...
                print('OKAY!')
    print(f'File comparing time:{time.time_ns() - time_start} ns')